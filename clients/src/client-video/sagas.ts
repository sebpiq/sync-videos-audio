...
import { FollowerConnectMessage, Message, TimeDiffResponseMessage, WEBSOCKET_MESSAGE_FOLLOWER_CONNECT, WEBSOCKET_MESSAGE_FOLLOWER_CONNECTED, WEBSOCKET_MESSAGE_TIME_DIFF_QUERY, WEBSOCKET_MESSAGE_TIME_DIFF_RESPONSE } from '../shared/websocket-messages'
